...
DROP POLICY IF EXISTS "Backoffice can view all properties" ON properties;
...
DROP POLICY IF EXISTS "Users can manage maintenance requests in their properties" ON maintenance_requests;
...
DROP POLICY IF EXISTS "Superadmin can manage users" ON backoffice_users;
DROP POLICY IF EXISTS "Users can view backoffice users" ON backoffice_users;
